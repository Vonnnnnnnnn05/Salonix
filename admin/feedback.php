...
$feedback = mysqli_query(
    ...
    "SELECT af.rating, af.comments, af.created_at, a.appointment_date, a.start_time,
            customer.full_name AS customer_name, staff.full_name AS staff_name, s.service_name
...
<body class="bg-[#F9FAFB] text-[#2D2D2D]">
    ...
    <main class="min-h-screen lg:ml-72 px-4 pb-8 pt-20 sm:px-6 lg:px-8 lg:pt-8">
        <section class="rounded-2xl border border-[#E5E7EB] bg-white p-6 shadow-md">
            ...
            <p class="mt-1 text-sm text-gray-500">Ratings and comments submitted after completed services.</p>
        </section>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full text-left text-sm">
                    ...
                    <?php if ($feedback && mysqli_num_rows($feedback) > 0): ?>
                        ...
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr><td colspan="6" class="px-4 py-6 text-center text-gray-500">No feedback submitted yet.</td></tr>
                    <?php endif; ?>
                    </tbody>
                </table>
            </div>
